      ...
      <div className={`mobile-menu ${isMenuOpen ? 'open' : ''}`}>
        <div className="menu-header">
          <div className="menu-logo">
            EVENT<br/><span className="menu-logo-sub">PREMIUM MANAGEMENT</span>
          </div>
      ...
      <section id="about" className="section container">
        ...
        >
          ...
          <div className="about-content">
            ...
            <motion.p variants={fadeInRight}>At Event & Exhibition, we specialize in scaling your ideas into massive, breathtaking realities. Our expert planners and architects work seamlessly to deliver structural brilliance, technical perfection, and stunning aesthetics.</motion.p>
        ...
        <div className="container">
          <div className="footer-top">
            <div className="footer-col">
              <h3 className="logo" style={{color: '#333'}}>Event <span className="heading-italic">&</span> Exhibition</h3>
          ...
          <div className="footer-bottom">
            <span>&copy; {new Date().getFullYear()} EVENT & EXHIBITION. ALL RIGHTS RESERVED.</span>
